...
git remote add github https://$GITHUB_TOKEN@github.com/aditya/vue-player-tool.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/aditya/vue-player-tool/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "vue-player-tool更新", "text": "@所有人\n# [vue-player-tool('$version')]('$html_url')\n'$body'"}}'
